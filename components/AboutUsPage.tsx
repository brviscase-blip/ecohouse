  ...
  return (
    <div className="bg-white dark:bg-slate-950 transition-colors duration-500 min-h-screen">
      ...
      <section className="relative py-32 md:py-48 bg-[#0a0f12] overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 text-center space-y-6 md:space-y-8">
          <div className="inline-flex items-center justify-center p-4 md:p-6 bg-emerald-500/10 backdrop-blur-md rounded-full border border-emerald-500/20 mb-2 animate-fade-in">
            <Users className="h-10 w-10 md:h-14 md:w-14 text-emerald-500" />
          </div>
      ...
      <section className="py-20 md:py-32 bg-white dark:bg-slate-950 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
            ...
            <div className="lg:col-span-7 relative h-[300px] md:h-[600px] order-2 lg:order-1 mt-8 lg:mt-0">
            ...
            <div className="lg:col-span-5 space-y-8 md:space-y-12 relative z-10 order-1 lg:order-2">
              <div className="space-y-6">
                ...
                <h3 className="text-4xl md:text-6xl font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-[0.9]">
                  ECOHOUSE <br/>
      ...
      {/* ECOPRO SECTION */}
      <section className="py-20 md:py-32 bg-gray-50 dark:bg-slate-900 border-t border-gray-100 dark:border-slate-800 relative overflow-hidden">
        <div className="max-w-[1400px] mx-auto px-6 md:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
            
            <div className="lg:col-span-5 space-y-8 md:space-y-12 relative z-10">
              <div className="space-y-6">
                <div className="flex items-center gap-4">
            ...
            <div className="lg:col-span-7 relative h-[300px] md:h-[600px] mt-8 lg:mt-0">
      ...
      <section className="py-20 md:py-40 bg-white dark:bg-slate-950 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 md:px-16">
          <div className="text-center mb-16 md:mb-24 space-y-4">
            ...
            <h3 className="text-3xl md:text-5xl font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-none">Manifesto <span className="text-emerald-500">Corporativo.</span></h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16">
            {[
              ...
              <div key={i} className={`group bg-slate-50 dark:bg-slate-900 p-8 md:p-12 border-t-4 ${box.border} shadow-lg transition-all flex flex-col items-start`}>
                <div className={`w-14 h-14 md:w-16 md:h-16 ${box.color} ${i === 1 ? 'text-white dark:text-slate-900' : 'text-white'} rounded-2xl flex items-center justify-center mb-8 shadow-md`}>
                  {box.icon}
                </div>
                <h4 className="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tighter mb-4 md:mb-6">{box.title}</h4>
      ...
      {/* CTA FINAL */}
      <section className="py-24 md:py-48 bg-emerald-950 text-white relative overflow-hidden group">
        <div className="absolute inset-0 z-0">
          <img 
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 space-y-10 md:space-y-12">
          ...
          <button 
            ...
            className="w-full sm:w-auto px-8 md:px-16 py-5 md:py-6 bg-white text-emerald-900 font-black text-[10px] md:text-[11px] uppercase tracking-[0.3em] md:tracking-[0.4em] rounded-full hover:bg-emerald-500 hover:text-white transition-all shadow-2xl active:scale-95 leading-tight"
          >
            Entrar em contato
          </button>
        </div>
